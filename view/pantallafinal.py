...
def pantalla_final(ventana, tiempo_total, mensaje="PERDISTE", color_titulo=(234, 67, 53)):
    ...
    while True:
        ...
        for event in pygame.event.get():
            if event.type == pygame.MOUSEBUTTONDOWN and btn_reiniciar.collidepoint(event.pos):
                return True
        ...
        # Título
        txt_titulo = fuente_titulo.render(mensaje, True, color_titulo)
        ventana.blit(txt_titulo, (frame_rect.centerx - txt_titulo.get_width() // 2, frame_rect.y + 32))
        ...
        ventana.blit(txt_btn, (btn_reiniciar.centerx - txt_btn.get_width() // 2,
                               btn_reiniciar.centery - txt_btn.get_height() // 2))
