...
def Ganaste(ventana, tiempo_total):
    pygame.font.init()
    ...
    while True:
        ...
        # Título
        txt_ganaste = fuente_titulo.render('GANASTE', True, ROJO)
        ventana.blit(txt_ganaste, (frame_rect.centerx - txt_ganaste.get_width() // 2, frame_rect.y + 32))
